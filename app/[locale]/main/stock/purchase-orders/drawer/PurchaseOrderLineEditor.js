...
import { usePurchaseOrderLineUomOptions } from "./usePurchaseOrderDrawerData";
...
/**
 * @param {{
 *   lines: import("./purchaseOrderDrawerUtils").PurchaseOrderLineFormRow[];
 *   readOnly: boolean;
 *   itemOptions: { value: string; label: string }[];
 *   itemsPending: boolean;
 *   canAddLine: boolean;
 *   onPatchLine: (index: number, patch: Partial<import("./purchaseOrderDrawerUtils").PurchaseOrderLineFormRow>) => void;
    ...
    <section className="item-lines-panel">
      ...
      <ItemDrawerLinesGrid
        ...
        renderField={(line, index, columnKey) => {
          const row = /** @type {import("./purchaseOrderDrawerUtils").PurchaseOrderLineFormRow} */ (line);
          if (columnKey === "item") {
            return (
              <Select
                showSearch
