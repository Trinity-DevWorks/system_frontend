...
import { useMediaPreviewBlob } from "@/shared/components/attachments/useMediaPreviewBlob";
import { formatFileSize } from "@/shared/components/attachments/attachmentPreviewUtils";
import dynamic from "next/dynamic";
import { Alert, Modal, Spin } from "antd";

const ImageGalleryViewer = dynamic(() => import("@/shared/components/attachments/viewers/ImageGalleryViewer"), {
  ssr: false,
});
