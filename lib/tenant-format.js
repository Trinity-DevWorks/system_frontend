...
/** @type {Record<import("@/lib/tenant-settings").DateFormat, string>} */
...
/** @type {Record<import("@/lib/tenant-settings").NumberFormat, { thousands: string, decimal: string }>} */
 ...
 *   settings?: import("@/lib/tenant-settings").TenantSettings
 * }} [options]
 * @returns {string}
 */
