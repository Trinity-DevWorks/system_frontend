...
export function useTenantListBulkDelete({
  ...
  const bulkDeleteMutation = useMutation({
    ...
    onSuccess: (/** @type {{ successfulIds: string[], failures: { id: string, reason: unknown }[] }} */ result) => {
      ...
      if (openId != null && successfulIds.includes(String(openId)) && typeof closeDrawer === "function") {
        closeDrawer();
      }
    },
  });
