...
export function getAppCssVars(isDark) {
  return {
    ...
    /* Module rail: a constant dark surface in both modes, so the workspace keeps
       the navy identity of the auth screens and the content stays the bright plane. */
    "--app-rail-bg": isDark ? APP_PALETTE.navyDeep : APP_PALETTE.navy,
    "--app-rail-fg": "rgba(255, 255, 255, 0.62)",
    "--app-rail-fg-strong": "#FFFFFF",
    "--app-rail-hover-bg": "rgba(255, 255, 255, 0.08)",
    "--app-rail-active-bg": isDark ? APP_PALETTE.primaryDark : APP_PALETTE.accent,
    "--app-rail-active-fg": "#FFFFFF",
    "--app-rail-border": "rgba(255, 255, 255, 0.08)",

    /* Elevation scale — chrome overlays (peeked panel, dropdowns) read as raised. */
