...
export const PAYMENT_METHODS_LIST_QUERY_KEY = /** @type {const} */ (["tenant", "payment-methods"]);

/** @param {number | string} id */
export function paymentMethodDetailQueryKey(id) {
  return [...PAYMENT_METHODS_LIST_QUERY_KEY, id];
}
