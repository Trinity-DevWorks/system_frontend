/**
 * Production list query with server-side filters and pagination.
 */

import { QUERY_STALE_TIME } from "@/lib/queryStaleTime";
import { PRODUCTIONS_QUERY_KEY } from "./stockQueryKeys";
import { fetchProductions } from "../api/productions.api";
 ...
 * }} args
 */
export function useProductionsTableQuery({
  t,
  tApiErrors,
  notification,
  status,
  ...
  const table = useTenantPaginatedTable({
    queryKey: PRODUCTIONS_QUERY_KEY,
