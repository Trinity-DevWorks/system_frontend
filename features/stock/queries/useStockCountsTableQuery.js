/**
 * Stock count list query with server-side filters and pagination.
 */

import { QUERY_STALE_TIME } from "@/lib/queryStaleTime";
import { STOCK_COUNTS_QUERY_KEY } from "./stockQueryKeys";
import { fetchStockCounts } from "../api/stockCounts.api";
 ...
 * }} args
 */
export function useStockCountsTableQuery({
  t,
  tApiErrors,
  notification,
  status,
  ...
  const table = useTenantPaginatedTable({
    queryKey: STOCK_COUNTS_QUERY_KEY,
