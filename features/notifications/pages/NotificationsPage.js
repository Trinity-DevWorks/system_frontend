...
import { navigateNotificationActionPath } from "../utils/navigateNotificationActionPath";
import { usePathname, useRouter } from "@/i18n/navigation";
import { useNotificationReadMutations } from "../queries/useNotificationReadMutations";
import {
...
function NotificationsPageInner() {
  ...
  const listQuery = useQuery({
    queryKey: [...NOTIFICATIONS_QUERY_KEY, "page", filter, page],
    queryFn: () =>
      fetchNotifications({
        page,
        per_page: PAGE_SIZE,
