...
import { useCategoryDrawerMutations } from "../../queries/useCategoryMutations";
import { CATEGORIES_LIST_QUERY_KEY } from "../../queries/categoriesQueryKeys";

const CATEGORY_DETAIL_QUERY_PREFIX = /** @type {const} */ (CATEGORIES_LIST_QUERY_KEY);
