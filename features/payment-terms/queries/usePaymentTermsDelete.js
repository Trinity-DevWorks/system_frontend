...
import { deletePaymentTerm } from "../api/paymentTerms.api";
 ...
 * }} args
 */
export function usePaymentTermsDelete({
  t,
  tApiErrors,
  tDataTable,
  notification,
  ...
  const { requestDelete: requestDeletePaymentTerm } = useTenantListRowDelete({
    listQueryKey: PAYMENT_TERMS_LIST_QUERY_KEY,
  ...
  return { requestDeletePaymentTerm, openBulkDeleteConfirm, bulkDeletePending };
}
