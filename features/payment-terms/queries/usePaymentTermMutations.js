...
export function usePaymentTermDrawerMutations({
  ...
  const createMutation = useMutation({
    ...
    onMutate: async ({ payload }) => {
      ...
      patchTenantListCacheForCreate(queryClient, listKey, (rows) => sortPaymentTermsByName([...rows, optimisticRow]));
    ...
    onSettled: () => {
      invalidateTenantListQueries(queryClient, PAYMENT_TERMS_LIST_QUERY_KEY);
    },
  });
