...
import { useUnitOfMeasurementDrawerMutations } from "../../queries/useUnitOfMeasurementMutations";
import { UNIT_OF_MEASUREMENTS_LIST_QUERY_KEY } from "../../queries/unitOfMeasurementsQueryKeys";

const UOM_DETAIL_QUERY_PREFIX = /** @type {const} */ (UNIT_OF_MEASUREMENTS_LIST_QUERY_KEY);
